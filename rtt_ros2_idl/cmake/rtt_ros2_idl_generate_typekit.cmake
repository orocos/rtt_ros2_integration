...
function(_rtt_ros2_generate_typekit _package)
  ...
  foreach(_file ${${_package}_INTERFACE_FILES})
    ...
    if(_path STREQUAL "msg" AND _extension STREQUAL ".msg")
      if((NOT DEFINED ARG_MESSAGES OR ${_type} IN_LIST ARG_MESSAGES) AND NOT ${_type} IN_LIST ARG_EXCLUDE_MESSAGES)
    ...
    if(_path STREQUAL "srv" AND _extension STREQUAL ".srv")
      if((NOT DEFINED ARG_SERVICES OR ${_type} IN_LIST ARG_SERVICES) AND NOT ${_type} IN_LIST ARG_EXCLUDE_SERVICES)
    ...
    if(_path STREQUAL "action" AND _extension STREQUAL ".action")
      if((NOT DEFINED ARG_ACTIONS OR ${_type} IN_LIST ARG_ACTIONS) AND NOT ${_type} IN_LIST ARG_EXCLUDE_ACTIONS)
